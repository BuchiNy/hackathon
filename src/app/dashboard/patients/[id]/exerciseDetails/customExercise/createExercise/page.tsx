...
export default function CreateExercise(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      {/* Title */}
      <div className="bg-white border-gray-200 px-6 py-4 flex-shrink-0">
        <h1 className="text-ml font-semibold text-gray-900">Exercise Details</h1>
      </div>
      ...
      <div className="flex flex-1 px-6 py-4 gap-6">
        ...
        <div className="flex-1">
          <h2 className="text-lg font-medium text-gray-800 mb-2">Exercise Preview</h2>
      ...
      <div className="px-6 py-4 flex justify-between">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700">Save to Library</button>
          <button className="px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700">Save Exercise</button>
        </div>
      </div>
    </div>
  );
