...
export default function Page() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
      <h1 className="text-2xl md:text-3xl font-bold mb-6 text-gray-800">Patients List</h1>
      ...
      <div className="space-y-4 md:space-y-0 md:divide-y md:border md:rounded-lg md:bg-white md:shadow-sm overflow-hidden">
        {patients.map((patient) => (
          <div
            ...
            onClick={() =>
              router.push(
                `/dashboard/patients/${patient.id}/exerciseDetails?name=${encodeURIComponent(
                  patient.name
                )}`
              )
            }
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1 md:mt-0">
                  ID: <span className="font-semibold text-gray-700">{patient.id}</span>
                </p>
              </div>
            </div>
