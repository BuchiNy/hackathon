...
export default function UserUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setInjuryHistory(cleanValues.injuryHistory);
    setConditions(cleanValues.conditions ?? []);
    setCurrentConditionsValue("");
    setGoals(cleanValues.goals ?? []);
    setCurrentGoalsValue("");
    setMobilityLevel(cleanValues.mobilityLevel);
    setPainScale(cleanValues.painScale);
    setTargetBodyParts(cleanValues.targetBodyParts ?? []);
    setCurrentTargetBodyPartsValue("");
    setAvailableEquipment(cleanValues.availableEquipment ?? []);
    setCurrentAvailableEquipmentValue("");
    setPreferredTime(cleanValues.preferredTime);
    setReminderEnabled(cleanValues.reminderEnabled);
    setErrors({});
  };
